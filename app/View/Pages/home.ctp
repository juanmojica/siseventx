...
<div class="jumbotron mt-3">
  ...
  <a class="btn btn-primary btn-lg" href="/espacos" role="button">Ver espaços disponíveis</a>
</div>
<div class="row">
  <div class="col-md-6">
    ...
    <p><a class="btn btn-secondary" href="/sobre" role="button">Saiba mais &raquo;</a></p>
  </div>
  <div class="col-md-6">
    ...
    <p><a class="btn btn-secondary" href="/contato" role="button">Entre em contato &raquo;</a></p>
  </div>
</div>
